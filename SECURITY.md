...
![BooAdmin](https://img.shields.io/badge/BooAdmin-v1.2.-blue?style=for-the-badge)
...
| 版本 | 状态 | 说明 |
| :--- | :---: | :--- |
| **v1.2.3** | ✅ 支持 | 当前主分支，持续接收安全更新 |
| **v1.1.x 系列** | ❌ EOL | 已完成样式重构，停止维护，请升级至 v1.2.3 及更高 |
| **v1.0.x 系列** | ❌ EOL | 已抵达生命周期，停止维护，请升级至 v1.2.3 及更高 |
